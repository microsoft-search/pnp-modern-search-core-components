...
export class NonReactiveTextField extends React.Component<INonReactiveTextFieldProps, INonReactiveTextFieldState> {
    ...
    public componentDidUpdate(prevProps: INonReactiveTextFieldProps): void {
    ...
    public _onChange(event: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>, newValue?: string): void {
