...
export class ServiceScopeHelper {
	 ...
	 */
	public static registerChildServices(rootScope: ServiceScope, serviceKeys: ServiceKey<unknown>[]): ServiceScope {
	 ...
	 * @returns 
	 */
	public static getRootServiceScope(scope: ServiceScope): ServiceScope {
